<div class="article">
  <p>We ship a simple normalization that can be used to easily style an application. Due to limitations in SASS we are unable to control the dark / light mode colors of the noramalize using SASS variables, so in this case we use CSS Custom properties for the light / dark theme colors (which are in-turned pulled from the grey color palette).</p>
  <p>To include the normalize within your css you simply need to import it</p>
  <pre>@use 'bridgecss/normalize.scss' as *;</pre>
</div>
<div class="normalize">
 <header role="banner">
   <p>A very simple normalize style that supports dark mode out of the box</p>
    <div>
      <h4>Included adaptive props</h4>
      <h3>4 Surface Colors</h3>
      <p>Great for cards, buttons, borders, sidenavs, wells, etc. When you want to change the perception of layering
        and grouping.</p>
    ...
    <div class="text-samples">
      ...
      <p>The brand color is used sparingly, find it used in the HTML elements below! The link color is useful for
        buttons and other custom components you want to have consistent interactive text for.</p>
    </div>
    <hr>
    ...
    <section id="embedded">
      ...
      <article id="embedded__images">
        ...
        <div class="spaced">
          ...
          <p><img src="https://doodleipsum.com/420/outline?bg=7463D9&i=5493adbcd8a47597df8e1fc4b1b87733"
              alt="Image alt text"></p>
          <h5>Wrapped in a <code>&lt;figure&gt;</code> element, no <code>&lt;figcaption&gt;</code></h5>
          <figure><img src="https://doodleipsum.com/420/outline?bg=7463D9&i=5493adbcd8a47597df8e1fc4b1b87733"
              alt="Image alt text"></figure>
          <h5>Wrapped in a <code>&lt;figure&gt;</code> element, with a <code>&lt;figcaption&gt;</code></h5>
          <figure>
            <img src="https://doodleipsum.com/420/outline?bg=7463D9&i=5493adbcd8a47597df8e1fc4b1b87733"
              alt="Image alt text">
...
.surface-samples {
  display: grid;
  grid-template-columns: spacing(70) spacing(70);
  grid-auto-rows: spacing(70);
  gap: spacing(5);
